...
func NewOrderCreator(orderRepository interfaces.OrderRepository, productRepository interfaces.ProductRepository) *OrderCreator {
	return &OrderCreator{
...
func (uc *OrderCreator) Create(ctx context.Context, orderInput *entities.Order) error {
