...
import (
	...
	interfaces "github.com/Pos-Tech-Challenge-48/delivery-api/internal/interfaces/usecases/customercreator"
	"github.com/Pos-Tech-Challenge-48/delivery-api/internal/usecases/customercreator"
	"github.com/gin-gonic/gin"
)

type CustomerCreatorHandler struct {
	customerCreatorUseCase interfaces.CustomerCreator
}

func NewCustomerCreatorHandler(customerCreatorUseCase interfaces.CustomerCreator) *CustomerCreatorHandler {
