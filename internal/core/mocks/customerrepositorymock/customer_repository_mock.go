...
func (m *MockCustomerRepository) GetByDocument(ctx context.Context, document string) (*domain.Customer, error) {
	m.ctrl.T.Helper()
...
func (m *MockCustomerRepository) Save(ctx context.Context, user *domain.Customer) error {
	m.ctrl.T.Helper()
