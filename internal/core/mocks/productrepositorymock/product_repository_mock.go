...
func (m *MockProductRepository) Add(ctx context.Context, product *domain.Product) error {
	m.ctrl.T.Helper()
...
func (m *MockProductRepository) GetAll(ctx context.Context, params string) ([]domain.Product, error) {
	m.ctrl.T.Helper()
